...
$sql = "INSERT INTO event_app.evento (id_codigo_evento,nombre_evt, lugar_evt, fecha_evt, hora_evt, cupo_evt, estatus_evt, foto_evt, link_evt, poster_evt, descripcion_evt)
                            VALUES ('$id_evt','$nombre_evt','$lugar_evt','$fecha_evt','$hora_evt','$cupo_evt','$estatus_evt','$foto_evt','$link_evt','$poster_evt','$descripcion_evt')";
